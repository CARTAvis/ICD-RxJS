...
let assertItem: AssertItem = {
    ...
    fileOpen: [
        ...
        {
            directory: testSubdirectory,
            file: 'M17_SWex-channel0-addOneGaussian-addBackgroundFlux.image',
            hdu: '0',
            fileId: 0,
            renderMode: CARTA.RenderMode.RASTER,
        },
    ...
    fittingRequest: [
        ...
        },
        {
            ...
            fovInfo: {
                controlPoints: [
                    { x: 319.5, y: 399.5 },
                    { x: 216.70644391408112, y: 199.99999999999997 },
                ],
                regionType: 3,
                rotation: 0,
            },
    ...
    fittingResponse: [
        {
            ...
            resultErrors: [
                {
                    center: {
                        x: 0.004862282328088298,
                        y: 0.006083234199648924,
                    },
        ...
        describe(`Go to "${assertItem.filelist.directory}" folder`, () => {
                ...
                test(
                    ...
                    async () => {
                        ...
                        expect(response.resultValues[0].amp).toBeCloseTo(
                            assertItem.fittingResponse[0].resultValues[0].amp,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].fwhm.x).toBeCloseTo(
                            assertItem.fittingResponse[0].resultValues[0].fwhm.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].fwhm.y).toBeCloseTo(
                            assertItem.fittingResponse[0].resultValues[0].fwhm.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].pa).toBeCloseTo(
                            assertItem.fittingResponse[0].resultValues[0].pa,
                            assertItem.precisionDigits
                        );
                        expect(response.success).toEqual(assertItem.fittingResponse[0].success);
                        expect(response.resultErrors[0].center.x).toBeCloseTo(
                            assertItem.fittingResponse[0].resultErrors[0].center.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].center.y).toBeCloseTo(
                            assertItem.fittingResponse[0].resultErrors[0].center.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].amp).toBeCloseTo(
                            assertItem.fittingResponse[0].resultErrors[0].amp,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].fwhm.x).toBeCloseTo(
                            assertItem.fittingResponse[0].resultErrors[0].fwhm.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].fwhm.y).toBeCloseTo(
                            assertItem.fittingResponse[0].resultErrors[0].fwhm.y,
                            assertItem.precisionDigits
                        );
                ...
                test(
                    ...
                    async () => {
                        ...
                        for (let i = 0; i < imageFittingProgressReponse2.length; i++) {
                            console.log(
                                '[Case 2 - 1] Image Fitting progress :',
                                imageFittingProgressReponse2[i].progress
                            );
                        }

                        expect(response.resultValues[0].center.x).toBeCloseTo(
                            assertItem.fittingResponse[1].resultValues[0].center.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].center.y).toBeCloseTo(
                            assertItem.fittingResponse[1].resultValues[0].center.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].amp).toBeCloseTo(
                            assertItem.fittingResponse[1].resultValues[0].amp,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].fwhm.x).toBeCloseTo(
                            assertItem.fittingResponse[1].resultValues[0].fwhm.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].fwhm.y).toBeCloseTo(
                            assertItem.fittingResponse[1].resultValues[0].fwhm.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].pa).toBeCloseTo(
                            assertItem.fittingResponse[1].resultValues[0].pa,
                            assertItem.precisionDigits
                        );
                        expect(response.success).toEqual(assertItem.fittingResponse[1].success);
                        expect(response.resultErrors[0].center.x).toBeCloseTo(
                            assertItem.fittingResponse[1].resultErrors[0].center.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].center.y).toBeCloseTo(
                            assertItem.fittingResponse[1].resultErrors[0].center.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].amp).toBeCloseTo(
                            assertItem.fittingResponse[1].resultErrors[0].amp,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].fwhm.x).toBeCloseTo(
                            assertItem.fittingResponse[1].resultErrors[0].fwhm.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].fwhm.y).toBeCloseTo(
                            assertItem.fittingResponse[1].resultErrors[0].fwhm.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].pa).toBeCloseTo(
            ...
            describe(`(Case 2 - 2) Image fitting with FoV (solver = QR):`, () => {
                test(
                    ...
                    async () => {
                        ...
                        for (let i = 0; i < imageFittingProgressReponse2.length; i++) {
                            console.log(
                                '[Case 2 - 2] Image Fitting progress :',
                                imageFittingProgressReponse2[i].progress
                            );
                        }
            ...
            describe(`(Case 2 - 3) Image fitting with FoV (solver = SVD):`, () => {
                test(
                    ...
                    async () => {
                        ...
                        for (let i = 0; i < imageFittingProgressReponse2.length; i++) {
                            console.log(
                                '[Case 2 - 3] Image Fitting progress :',
                                imageFittingProgressReponse2[i].progress
                            );
                        }
            ...
            describe(`(Case 3) Image fitting without FoV and creating model image:`, () => {
                test(
                    ...
                    async () => {
                        ...
                        expect(RegionHistogramDataResponse1[0].fileId).toEqual(
                            assertItem.regionHistogramResponses[0].fileId
                        );
                        expect(RegionHistogramDataResponse1[0].progress).toEqual(
                            assertItem.regionHistogramResponses[0].progress
                        );
                        expect(RegionHistogramDataResponse1[0].regionId).toEqual(
                            assertItem.regionHistogramResponses[0].regionId
                        );
            ...
            describe(`(Case 4) Image fitting without FoV and creating model image and residual image:`, () => {
                test(
                    ...
                    async () => {
                        ...
                        RegionHistogramDataResponse2.map((data) => {
                            RegionHistogramDatafileID.push(data.fileId);
                        });
                ...
                test(`Request the tiles for the model image`, async () => {
                    ...
                    let RasterTileDataPromise = new Promise((resolve) => {
                        msgController.rasterTileStream
                            .pipe(take(assertItem.addTilesReq[2].tiles.length + assertItem.addTilesReq[3].tiles.length))
                            .subscribe({
                                next: (data) => {
            ...
            describe(`(Case 5) Image fitting with setting region and creating model image and residual image:`, () => {
                ...
                test(`Request the tiles for the model image`, async () => {
                    ...
                    let RasterTileDataPromise = new Promise((resolve) => {
                        msgController.rasterTileStream
                            .pipe(take(assertItem.addTilesReq[4].tiles.length + assertItem.addTilesReq[5].tiles.length))
                            .subscribe({
                                next: (data) => {
                                    RasterTileArray.push(data);
                                },
            ...
            describe(`(Case 6) Image fitting with setting region, sky offset and creating model image and residual image:`, () => {
                ...
                test(
                    ...
                    async () => {
                        ...
                        expect(response.resultValues[0].center.x).toBeCloseTo(
                            assertItem.fittingResponse[2].resultValues[0].center.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].center.y).toBeCloseTo(
                            assertItem.fittingResponse[2].resultValues[0].center.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].amp).toBeCloseTo(
                            assertItem.fittingResponse[2].resultValues[0].amp,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].fwhm.x).toBeCloseTo(
                            assertItem.fittingResponse[2].resultValues[0].fwhm.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].fwhm.y).toBeCloseTo(
                            assertItem.fittingResponse[2].resultValues[0].fwhm.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultValues[0].pa).toBeCloseTo(
                            assertItem.fittingResponse[2].resultValues[0].pa,
                            assertItem.precisionDigits
                        );
                        expect(response.success).toEqual(assertItem.fittingResponse[2].success);
                        expect(response.resultErrors[0].center.x).toBeCloseTo(
                            assertItem.fittingResponse[2].resultErrors[0].center.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].center.y).toBeCloseTo(
                            assertItem.fittingResponse[2].resultErrors[0].center.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].amp).toBeCloseTo(
                            assertItem.fittingResponse[2].resultErrors[0].amp,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].fwhm.x).toBeCloseTo(
                            assertItem.fittingResponse[2].resultErrors[0].fwhm.x,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].fwhm.y).toBeCloseTo(
                            assertItem.fittingResponse[2].resultErrors[0].fwhm.y,
                            assertItem.precisionDigits
                        );
                        expect(response.resultErrors[0].pa).toBeCloseTo(
                ...
                test(`Request the tiles for the model image`, async () => {
                    ...
                    let RasterTileDataPromise = new Promise((resolve) => {
                        msgController.rasterTileStream
                            .pipe(take(assertItem.addTilesReq[6].tiles.length + assertItem.addTilesReq[7].tiles.length))
                            .subscribe({
                                next: (data) => {
                                    RasterTileArray.push(data);
                                },
