...
export class MessageController {
    ...
    // Retrying a fixed number of times bounds nothing: an attempt against a refused port fails in
    // a few milliseconds, but one whose packets are dropped stays pending for as long as the OS
    // allows, so a count says nothing about how long connect() can run. What has to be bounded is
    // the wall clock, because config.timeout.connection is also the jest timeout of the beforeAll
    // block which calls connect(). Retrying within a budget derived from that value keeps the two
    // in step: a backend which never arrives is reported by the rejection raised below, rather
    // than by jest killing the hook first and losing the reason.
    private static readonly ConnectionBudget = config.timeout.connection * 0.9;
    // Bounding the handshake turns an unreachable host into an ordinary retry instead of a single
    // attempt which outlives the whole budget.
    ...
    private constructor() {
        ...
        this.decoderMap = new Map<CARTA.EventType, { messageClass: any; handler: HandlerFunction }>([
            ...
            [
                CARTA.EventType.REGION_LIST_RESPONSE,
                {
                    messageClass: CARTA.RegionListResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.CATALOG_LIST_RESPONSE,
                {
                    messageClass: CARTA.CatalogListResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.FILE_LIST_PROGRESS,
                {
                    messageClass: CARTA.ListProgress,
                    handler: this.onStreamedListProgress,
                },
            ],
            [
                CARTA.EventType.FILE_INFO_RESPONSE,
                {
                    messageClass: CARTA.FileInfoResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.REGION_FILE_INFO_RESPONSE,
                {
                    messageClass: CARTA.RegionFileInfoResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.CATALOG_FILE_INFO_RESPONSE,
                {
                    messageClass: CARTA.CatalogFileInfoResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                ...
                {
                    messageClass: CARTA.OpenFileAck,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.SAVE_FILE_ACK,
                {
                    messageClass: CARTA.SaveFileAck,
                    handler: this.onSaveFileAndRegionAck,
                },
            ],
            [
                CARTA.EventType.OPEN_CATALOG_FILE_ACK,
                {
                    messageClass: CARTA.OpenCatalogFileAck,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.IMPORT_REGION_ACK,
                {
                    messageClass: CARTA.ImportRegionAck,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.EXPORT_REGION_ACK,
                {
                    messageClass: CARTA.ExportRegionAck,
                    handler: this.onSaveFileAndRegionAck,
                },
            ],
            [
                CARTA.EventType.SET_REGION_ACK,
                {
                    messageClass: CARTA.SetRegionAck,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.RESUME_SESSION_ACK,
                {
                    messageClass: CARTA.ResumeSessionAck,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                ...
                {
                    messageClass: CARTA.StartAnimationAck,
                    handler: this.onStartAnimationAck,
                },
            ],
            [
                CARTA.EventType.RASTER_TILE_DATA,
                {
                    messageClass: CARTA.RasterTileData,
                    handler: this.onStreamedRasterTileData,
                },
            ],
            [
                CARTA.EventType.REGION_HISTOGRAM_DATA,
                {
                    messageClass: CARTA.RegionHistogramData,
                    handler: this.onStreamedRegionHistogramData,
                },
            ],
            [
                CARTA.EventType.ERROR_DATA,
                {
                    messageClass: CARTA.ErrorData,
                    handler: this.onStreamedErrorData,
                },
            ],
            [
                CARTA.EventType.SPATIAL_PROFILE_DATA,
                {
                    messageClass: CARTA.SpatialProfileData,
                    handler: this.onStreamedSpatialProfileData,
                },
            ],
            [
                CARTA.EventType.SPECTRAL_PROFILE_DATA,
                {
                    messageClass: CARTA.SpectralProfileData,
                    handler: this.onStreamedSpectralProfileData,
                },
            ],
            [
                CARTA.EventType.REGION_STATS_DATA,
                {
                    messageClass: CARTA.RegionStatsData,
                    handler: this.onStreamedRegionStatsData,
                },
            ],
            [
                CARTA.EventType.CONTOUR_IMAGE_DATA,
                {
                    messageClass: CARTA.ContourImageData,
                    handler: this.onStreamedContourData,
                },
            ],
            [
                CARTA.EventType.CATALOG_FILTER_RESPONSE,
                {
                    messageClass: CARTA.CatalogFilterResponse,
                    handler: this.onStreamedCatalogData,
                },
            ],
            [
                CARTA.EventType.RASTER_TILE_SYNC,
                {
                    messageClass: CARTA.RasterTileSync,
                    handler: this.onStreamedRasterSync,
                },
            ],
            [
                CARTA.EventType.MOMENT_PROGRESS,
                {
                    messageClass: CARTA.MomentProgress,
                    handler: this.onStreamedMomentProgress,
                },
            ],
            [
                CARTA.EventType.MOMENT_RESPONSE,
                {
                    messageClass: CARTA.MomentResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.SCRIPTING_REQUEST,
                {
                    messageClass: CARTA.ScriptingRequest,
                    handler: this.onScriptingRequest,
                },
            ],
            [
                CARTA.EventType.CONCAT_STOKES_FILES_ACK,
                {
                    messageClass: CARTA.ConcatStokesFilesAck,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.PV_PROGRESS,
                {
                    messageClass: CARTA.PvProgress,
                    handler: this.onStreamedPvProgress,
                },
            ],
            [
                CARTA.EventType.PV_RESPONSE,
                {
                    messageClass: CARTA.PvResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.FITTING_PROGRESS,
                {
                    messageClass: CARTA.FittingProgress,
                    handler: this.onStreamedFittingProgress,
                },
            ],
            [
                CARTA.EventType.FITTING_RESPONSE,
                {
                    messageClass: CARTA.FittingResponse,
                    handler: this.onDeferredResponse,
                },
            ],
            [
                CARTA.EventType.VECTOR_OVERLAY_TILE_DATA,
                {
                    messageClass: CARTA.VectorOverlayTileData,
                    handler: this.onStreamedVectorOverlayData,
                },
            ],
            [
                CARTA.EventType.PV_PREVIEW_DATA,
                {
                    messageClass: CARTA.PvPreviewData,
                    handler: this.onStreamedPvPreviewData,
                },
            ],
            [
                CARTA.EventType.REMOTE_FILE_RESPONSE,
                {
    ...
    async connect(url: string): Promise<CARTA.IRegisterViewerAck> {
        ...
        const retryDeadline = Date.now() + MessageController.ConnectionBudget;
        ...
        this.serverUrl = url;
        this.connection = new WebSocket(url, { handshakeTimeout: MessageController.HandshakeTimeout });
        ...
        this.connection.onclose = (ev: CloseEvent) =>
            runInAction(() => {
                ...
                const nextAttemptCost = MessageController.ConnectionAttemptDelay + MessageController.HandshakeTimeout;
                ...
                if (this.connectionStatus === ConnectionStatus.ACTIVE || isReconnection || budgetExhausted) {
                    ...
                    console.log(
                        `Connection to ${url} failed (${lastConnectionError || `code=${ev.code}`}), retry ${connectionAttempts} in ${MessageController.ConnectionAttemptDelay} ms (${budgetLeft} ms of budget left)`
                    );
                    setTimeout(() => {
                        const newConnection = new WebSocket(url, {
                            handshakeTimeout: MessageController.HandshakeTimeout,
                        });
        ...
        this.connection.onopen = action(() => {
            ...
            const message = CARTA.RegisterViewer.create({
                ...
                clientFeatureFlags: MessageController.DefaultFeatureFlags,
            });
        ...
        // first failure and leave the retry budget unspent, which is why the reason is only recorded
        // and the decision to give up is left to onclose.
    ...
    async getFileList(
        ...
        filterMode: CARTA.FileListFilterMode
    ): Promise<CARTA.IFileListResponse> {
    ...
    async getRegionList(
        directory: string | null,
        filterMode: CARTA.FileListFilterMode
    ): Promise<CARTA.IRegionListResponse> {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            throw new Error('Not connected');
        } else {
            const message = CARTA.RegionListRequest.create({
                directory,
                filterMode,
            });
            const requestId = this.eventCounter;
    ...
    async getCatalogList(
        directory: string | null,
        filterMode: CARTA.FileListFilterMode
    ): Promise<CARTA.ICatalogListResponse> {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            throw new Error('Not connected');
        } else {
            const message = CARTA.CatalogListRequest.create({
                directory,
                filterMode,
            });
            const requestId = this.eventCounter;
            ...
            if (
                this.sendEvent(CARTA.EventType.CATALOG_LIST_REQUEST, CARTA.CatalogListRequest.encode(message).finish())
            ) {
    ...
    async getRegionFileInfo(
        directory: string | null | undefined,
        file: string | null | undefined
    ): Promise<CARTA.IRegionFileInfoResponse> {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            throw new Error('Not connected');
        } else {
            const message = CARTA.RegionFileInfoRequest.create({
                directory,
                file,
            });
            const requestId = this.eventCounter;
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.REGION_FILE_INFO_REQUEST,
                    CARTA.RegionFileInfoRequest.encode(message).finish()
                )
            ) {
    ...
    async getCatalogFileInfo(
        ...
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            ...
            const message = CARTA.CatalogFileInfoRequest.create({
                directory,
                name,
            });
            const requestId = this.eventCounter;
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.CATALOG_FILE_INFO_REQUEST,
                    CARTA.CatalogFileInfoRequest.encode(message).finish()
                )
            ) {
    ...
    async importRegion(
        ...
        type: CARTA.FileType,
        fileId: number
    ): Promise<CARTA.IImportRegionAck> {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            throw new Error('Not connected');
        } else {
            const message = CARTA.ImportRegion.create({
                directory,
                file,
                type,
                groupId: fileId,
    ...
    async exportRegion(
        ...
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            ...
            const message = CARTA.ExportRegion.create({
                directory,
                file,
                type,
                fileId,
                regionStyles: mapToObject(regionStyles),
                coordType,
                overwrite,
            });
            const requestId = this.eventCounter;
    ...
    async loadStokeFiles(
        stokesFiles: CARTA.IStokesFile[],
        fileId: number,
        renderMode: CARTA.RenderMode
    ): Promise<CARTA.IConcatStokesFilesAck> {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            throw new Error('Not connected');
        } else {
    ...
    async loadCatalogFile(
        ...
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            ...
            const message = CARTA.OpenCatalogFile.create({
                directory,
                name,
                fileId,
                previewDataSize,
    ...
    async saveFile(
        ...
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            ...
            const message = CARTA.SaveFile.create({
                fileId,
                outputFileDirectory,
                outputFileName,
                outputFileType,
    ...
    setCatalogFilterRequest(filterRequest: CARTA.ICatalogFilterRequest) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.CATALOG_FILTER_REQUEST,
                    CARTA.CatalogFilterRequest.encode(filterRequest).finish()
                )
            ) {
                return true;
            }
    ...
    setSpatialRequirements(requirementsMessage: CARTA.ISetSpatialRequirements) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.SET_SPATIAL_REQUIREMENTS,
                    CARTA.SetSpatialRequirements.encode(requirementsMessage).finish()
                )
            ) {
                return true;
            }
    ...
    setSpectralRequirements(requirementsMessage: CARTA.ISetSpectralRequirements) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.SET_SPECTRAL_REQUIREMENTS,
                    CARTA.SetSpectralRequirements.encode(requirementsMessage).finish()
                )
            ) {
                return true;
            }
    ...
    setStatsRequirements(requirementsMessage: CARTA.ISetStatsRequirements) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.SET_STATS_REQUIREMENTS,
                    CARTA.SetStatsRequirements.encode(requirementsMessage).finish()
                )
            ) {
                return true;
            }
    ...
    setHistogramRequirements(requirementsMessage: CARTA.ISetHistogramRequirements) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.SET_HISTOGRAM_REQUIREMENTS,
                    CARTA.SetHistogramRequirements.encode(requirementsMessage).finish()
                )
            ) {
                return true;
            }
    ...
    removeRequiredTiles(fileId: number, tiles: Array<number>): boolean {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.REMOVE_REQUIRED_TILES,
                    CARTA.RemoveRequiredTiles.encode(message).finish()
                )
            ) {
                return true;
            }
    ...
    async startAnimation(animationMessage: CARTA.IStartAnimation): Promise<CARTA.IStartAnimationAck> {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(CARTA.EventType.START_ANIMATION, CARTA.StartAnimation.encode(animationMessage).finish())
            ) {
        ...
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    ...
                    CARTA.AnimationFlowControl.encode(message).finish()
                )
            ) {
                return true;
            }
    ...
    setContourParameters(message: CARTA.ISetContourParameters) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.SET_CONTOUR_PARAMETERS,
                    CARTA.SetContourParameters.encode(message).finish()
                )
            ) {
                return true;
            }
    ...
    setVectorOverlayParameters(message: CARTA.ISetVectorOverlayParameters) {
        if (this.connectionStatus === ConnectionStatus.ACTIVE) {
            ...
            if (
                this.sendEvent(
                    CARTA.EventType.SET_VECTOR_OVERLAY_PARAMETERS,
                    CARTA.SetVectorOverlayParameters.encode(message).finish()
                )
            ) {
                return true;
            }
    ...
    cancelRequestingFileList(fileListType: CARTA.FileListType) {
        if (this.connectionStatus !== ConnectionStatus.ACTIVE) {
            ...
            const message = CARTA.StopFileList.create({
    ...
    private messageHandler(event: MessageEvent) {
        ...
        if (eventIcdVersion !== MessageController.IcdVersion) {
            console.log(
                `Server event has ICD version ${eventIcdVersion}, which differs from frontend version ${MessageController.IcdVersion}. Errors may occur`
            );
        }
        try {
