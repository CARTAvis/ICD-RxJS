...
let assertItem: AssertItem = {
    ...
    addTilesReq: [
        ...
        },
        {
            ...
            compressionType: CARTA.CompressionType.ZFP,
            tiles: [
                50331648, 50335744, 50339840, 50343936, 50348032, 50331649, 50335745, 50339841, 50343937, 50348033,
                50331650, 50335746, 50339842, 50343938, 50348034, 50331651, 50335747, 50339843, 50343939, 50348035,
                50331652, 50335748, 50339844, 50343940, 50348036,
            ],
        },
        {
            fileId: 0,
    ...
    describe(`Register a session`, () => {
        ...
        describe(`Case 1: Open the image with axes sequence of Dec-Stokes-RA-Channel and test basic animator of  channel`, () => {
            ...
            describe(`(Step 3)Play some channels forwardly`, () => {
                ...
                test(
                    `running animation (channels) flow and stop within ${playAnimatorTimeout} ms`,
                    async () => {
                        ...
                        let lastRasterTileData = await Stream(
                            CARTA.RasterTileData,
                            assertItem.addTilesReq[1].tiles.length + 2
                        );
            ...
            describe(`(Step 4)Play some stokes forwardly`, () => {
                ...
                let RegionHistogramData: CARTA.RegionHistogramData[] = [];
                test(
                    `running animation (stokes) flow and stop within ${playAnimatorTimeout} ms`,
                    async () => {
                        await sleep(8000);
                        let StartAnimationResponse: CARTA.IStartAnimationAck;
