    ...
    describe(`Register a session`, () => {
        ...
        describe(`Go to "${testSubdirectory}" folder and open images`, () => {
            ...
            describe(`SET SPATIAL REQUIREMENTS`, () => {
                test(
                    `SPATIAL_PROFILE_DATA should arrive within ${regionTimeout} ms`,
                    async () => {
            ...
            describe('SET STATS REQUIREMENTS', () => {
                test(
                    `REGION_STATS_DATA should arrive within ${regionTimeout} ms`,
                    async () => {
            ...
            describe('SET IMAGE CHANNELS', () => {
                ...
                test(
                    `RASTER_TILE_DATA, SPATIAL_PROFILE_DATA, REGION_HISTOGRAM_DATA & REGION_STATS_DATA should arrive within ${changeChannelTimeout} ms`,
                    async () => {
