    ...
    addTilesReq: [
        {
            ...
            tiles: [
                67125252, 67129348, 67125253, 67129349, 67125251, 67121156, 67129347, 67121157, 67121155, 67133444,
                67125254, 67133445, 67129350, 67133443, 67121158, 67125250, 67117060, 67129346, 67117061, 67121154,
                67117059, 67133446, 67137540, 67125255, 67133442, 67117062, 67137541, 67129351, 67137539, 67121159,
                67117058, 67125249, 67129345, 67137542, 67133447, 67121153, 67137538, 67117063, 67133441, 67125256,
                67117057, 67129352, 67137543, 67121160, 67125248, 67133448, 67137537, 67129344, 67121152, 67117064,
                67133440, 67117056, 67137544, 67137536,
            ],
        },
    ],
    initTilesReq: {
...
describe('PERF_RASTER_TILE_DATA', () => {
    ...
    describe(`Register a session`, () => {
        ...
        describe(`Initialization: open the image`, () => {
            ...
            test(
                `(Step 2)"${assertItem.fileOpen[0].file}" RasterTileData responses should arrive within ${readFileTimeout} ms`,
                async () => {
