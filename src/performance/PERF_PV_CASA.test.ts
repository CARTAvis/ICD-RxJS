...
let assertItem: AssertItem = {
    ...
    addTilesReq: [
        ...
        },
        {
            ...
            compressionType: CARTA.CompressionType.ZFP,
            tiles: [
                67108870, 67108869, 67108871, 67108868, 67108872, 67108867, 67108873, 67108866, 67108874, 67108865,
                67108875, 67108864, 67108876,
            ],
        },
    ],
    setCursor: [
    ...
    setRegion: [
        {
            ...
            regionInfo: {
                ...
                controlPoints: [
                    { x: 3719.17546581019, y: 3663.715601206708 },
                    { x: 5897.900936510895, y: 5842.441071907413 },
                ],
                rotation: 135,
            },
        },
...
describe('PERF_PV', () => {
    ...
    describe(`Register a session`, () => {
        ...
        describe(`Initialization: open the image`, () => {
            ...
            test(
                `(step 2): set cursor and add required tiles`,
                async () => {
            ...
            let pvProgressData = [];
            test(
                `(Step 5): PV Response should arrived within ${PVTimeout} ms`,
                async () => {
